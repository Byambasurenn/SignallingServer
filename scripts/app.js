...
function registerLockedMouseEvents(playerElement) {
    ...
    playerElement.onmousedown = function(e) {
        ...
        emitUIInteraction({x: xOff, y: yOff});
    };
...
//----------------------------------------------------------------------------------------------------------
function getMessageFromServer(data){
    console.log("Got Message from server. byambaa");
    if(data){
        console.log("Selected Item: "+ data);
    }
}
addResponseEventListener("handle_responses", getMessageFromServer);
//------------------------------------------------------------------------
